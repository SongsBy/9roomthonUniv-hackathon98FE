...
import 'package:remind/screen/signinscreen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void login() {
    Navigator.of(
      context,
    ).push(MaterialPageRoute(builder: (BuildContext context) => TypeSettingGateScreen()));
  }
  ///회원 가입 로그인 구동 함수
  void signin() {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        Align(
          alignment: Alignment.center,
          child: Image.asset('assets/img/hedgehog.png', width: 130, height: 130),
        ),
        padding,
            ...
            TextButton(
              ...
              child: Column(
                children: [
                  Text(
                    '회원가입하기',
                    style: extraThinText?.copyWith(color: primaryColor),
                  ),
                  Container(
                    width: 78,
                    height: 1,
