...
import 'manual2_screen.dart';

class Manual1Screen extends StatelessWidget {
  const Manual1Screen({super.key});
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: IconButton(
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (_) => Manual2Screen()));
                    },
